<?php 
include 'server.php';
$sql=mysql_query("SELECT user.email, subscriber.email FROM user, subscriber WHERE user.email = subscriber.email");
...
<div class="container">
    <div class="row" id="row_style">
		...
		<?php
				 ...
				 $query1 = "insert into notify (title,body,read_n) VALUES ('$title','$body','1') WHERE user.email = subscriber.email";
