...
<div id="vcent">
  ...
  <div class="buttons">
    <input id="rock" name="flat" type="radio" onclick="location.href='courses.php'"/><label for="rock" >KIDS</label>
	<input id="paper" name="flat" type="radio"/><label for="paper"  onclick="location.href='courses.php'">SCOOL/COLLEGE</label>
	<input id="scissors" name="flat" type="radio"/><label for="scissors"  onclick="location.href='courses.php'">VARSITY</label>
  </div>
</div>
</body>
